    ...
    return (
      <button
        className={clsx(
          ...
          {
            'bg-vintage-primary hover:bg-vintage-primary/80 text-white ': variant === 'primary',
            'bg-gray-100 hover:bg-gray-200 text-gray-900 focus:ring-gray-500': variant === 'secondary',
            'border border-gray-300 hover:border-gray-400 bg-transparent text-gray-700 focus:ring-gray-500': variant === 'outline',
            'hover:bg-gray-100 text-gray-600 focus:ring-gray-500': variant === 'ghost',
